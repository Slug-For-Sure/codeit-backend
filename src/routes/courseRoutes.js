...
router.post("/content/track/add", userAuth, addTrack); // Add track to course content
router.delete("/content/track/remove", userAuth, removeTrack); // Delete track from course content
